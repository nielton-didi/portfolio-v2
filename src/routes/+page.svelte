...
>
	<div class={`mt-4 flex w-full flex-col items-center justify-start`}>
		<ul class={` flex h-full w-full flex-col items-center justify-start gap-2`}>
			{#each sections as section}
		...
		>
			...
			<div class={`flex w-full flex-row items-start justify-start gap-2`}>
				<a
					...
					target="_blank"
					class={`group flex h-8 min-h-8 flex-row items-center justify-center gap-2 rounded-md bg-light-neutral-100 px-3 text-base text-light-neutral-10 transition-all duration-300 ease-in-out hover:gap-3 hover:bg-light-neutral-90 dark:bg-dark-neutral-100 dark:text-dark-neutral-10`}
				>
					LinkedIn<span
						><svg
							fill="currentColor"
